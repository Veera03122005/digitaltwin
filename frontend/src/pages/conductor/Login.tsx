    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (user.role !== 'conductor') {
                throw new Error('Access denied. This login is for conductors only.')
            }
        ...
        <div className="gradient-bg" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 'var(--spacing-md)' }}>
            <div className="card glass" style={{ maxWidth: '450px', width: '100%' }}>
                <div className="text-center mb-4">
                    <h1 style={{ color: 'white', marginBottom: 'var(--spacing-sm)' }}>👨‍✈️ Conductor Login</h1>
                    <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '1.125rem' }}>Verify tickets and manage trips</p>
                </div>
